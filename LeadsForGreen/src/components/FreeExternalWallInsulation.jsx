...
Solid wall insulation – This is suitable for properties with solid walls, and involves the application of insulating material to the external walls.
...
export default FreeExternalWallInsulation;

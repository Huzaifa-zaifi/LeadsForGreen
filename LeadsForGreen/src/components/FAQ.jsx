  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section className="bg-sky-100 py-16 text-center">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <p className="text-gray-700 text-lg">
            ...
            about the ECO4 scheme and our services.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-6 max-w-4xl mx-auto space-y-8">
        <div>
          <h2 className="text-2xl font-semibold mb-2 text-sky-700">What is the ECO4 Scheme?</h2>
          <p className="text-gray-700">
            The ECO4 (Energy Company Obligation) scheme is a government initiative aimed at improving
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-2 text-sky-700">Who is eligible for ECO4 funding?</h2>
          <p className="text-gray-700">

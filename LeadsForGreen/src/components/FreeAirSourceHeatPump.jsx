...
const FreeAirSourceHeatPump = () => {
  ...
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
    ...
    <div>
      ...
      If you’re a homeowner in the UK, you may be eligible for a free or heavily subsidised air source heat pump installation under the ECO 4 scheme. The scheme is designed to help lower-income households or those in fuel poverty make their homes more energy-efficient by providing funding for energy-saving measures, including air source heat pump installation.
      </p>
      <p className="text-lg text-gray-700 mb-4">
      At Simplex Eco, we specialize in providing ECO 4 funding to help eligible homeowners access the funding they need to install a new and efficient air source heat pump. By upgrading to a modern and efficient heating system, you can reduce your energy bills and save money in the long term.
      </p>
      <p className="text-lg text-gray-700 mb-4">
      Under the ECO 4 scheme, air source heat pump installation funding is available to homeowners who meet the ECO criteria as set by Ofgem, and whose existing heating system is old and inefficient. The scheme provides funding to cover the cost of installation, as well as any necessary repairs or upgrades to your heating system.
      </p>
      <p className="text-lg text-gray-700 mb-4">
